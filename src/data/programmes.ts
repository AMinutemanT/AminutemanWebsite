...
const ankosha: Programme = {
  ...
  specs: [
    ...
    { label: 'Max take-off mass', value: 'Under 135 kg', note: 'At launch, fuelled' },
    ...
    { label: 'Launch altitude', value: 'To 4,570 m AMSL', note: '15,000 ft' },
    { label: 'Service ceiling', value: 'ON REQUEST', note: 'Released against a stated payload and atmosphere' },
    ...
    { label: 'Aural signature', value: 'ON REQUEST', note: 'Measured dB(A), loitering at 200 m overhead' },
