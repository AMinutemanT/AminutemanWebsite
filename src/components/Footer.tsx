        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-sm sm:text-base text-gray-400">
              Revolutionizing aerospace technology with advanced AI solutions
              for autonomous systems and military defense capabilities.
            </p>
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <p className="text-sm text-gray-400">
                      SR NO 22, Hora Building
                    </p>
                    <p className="text-sm text-gray-400">
                      Vishrantwadi road, Laxmi Nagar
                    </p>
                    <p className="text-sm text-gray-400">
                      Dhanori, Pune - 411015
                    </p>
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400 text-center sm:text-left">
              © {new Date().getFullYear()} Aminuteman Technologies. All rights
              reserved.
            </p>
