    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="https://images.unsplash.com/photo-1599171571332-c99754452072?auto=format&fit=crop&q=80"
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">Twin Turbo Engine</h1>
      ...
      >
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Next-Generation Engine Technology</h2>
              <p className="text-gray-300 text-lg mb-6">
                Our Twin Turbo Engine represents the pinnacle of military propulsion technology, delivering exceptional thrust-to-weight ratio and fuel efficiency. Designed for high-performance military aircraft, it sets new standards in reliability and performance.
              </p>
            </div>
            <img
