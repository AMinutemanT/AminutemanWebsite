    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img  loading="lazy"
            src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=60"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 text-lg mb-6">
                Our Mission Autonomy system leverages cutting-edge AI to
                automate mission planning, execution, and adaptation. It enables
                unmanned systems to operate independently while maintaining
                strategic objectives and safety parameters.
              </p>
            </div>
            <img  loading="lazy"
              src="https://images.unsplash.com/photo-1580894732444-8fee7c8c6396?auto=format&fit=crop&q=60"
