    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">Partner Program</h1>
      ...
      >
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Strategic Partnership Opportunities</h2>
              <p className="text-gray-300 text-lg mb-6">
                The Valley Partner Program connects industry leaders, innovators, and experts in defense technology. Our partnership network provides exclusive access to resources, training, and collaboration opportunities to drive innovation in military technology.
              </p>
            </div>
            <img
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-gray-300">Priority access to new technologies</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                  ...
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                    <span className="text-gray-300">Revenue sharing programs</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                    <span className="text-gray-300">Early access to beta features</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
