    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">Command & Control</h1>
          <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto">
            Advanced Command Center Solutions for Military Operations
          </p>
        </div>
      </div>
      ...
      >
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Centralized Control System</h2>
              <p className="text-gray-300 text-lg mb-6">
                Our Command & Control system provides military commanders with real-time situational awareness and decision-making capabilities. Integrated with AI-powered analytics, it enables rapid response to evolving tactical situations.
              </p>
            </div>
            <img
            ...
            {[
              {
                ...
                description: "Single interface for managing all military assets and operations."
              },
              {
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="bg-gray-800/50 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-4">Real-Time Operations</h3>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                    <span className="text-gray-300">Live tactical mapping and visualization</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                    <span className="text-gray-300">Automated threat detection and response</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                    <span className="text-gray-300">Multi-sensor data fusion</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                    <span className="text-gray-300">Secure voice and data communications</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                    <span className="text-gray-300">Mission planning and execution tools</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                    <span className="text-gray-300">After-action review and analysis</span>
                  </li>
                </ul>
              </div>
            </div>
