    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img  loading="lazy"
            src="https://images.unsplash.com/photo-1580894894513-541e068a3e2b?auto=format&fit=crop&q=60"
            alt="Command Center"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 text-lg mb-6">
                Our Command & Control system provides military commanders with
                real-time situational awareness and decision-making
                capabilities. Integrated with AI-powered analytics, it enables
                rapid response to evolving tactical situations.
              </p>
            </div>
            <img  loading="lazy"
              src="https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?auto=format&fit=crop&q=60"
