          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Valley-Powered Defense System
              </h2>
              <p className="text-gray-300 text-lg mb-6">
                Interceptor A leverages Valley's advanced command and control
                systems for superior air defense capabilities. Integrated with
                Valley Mission Autonomy, it provides automated threat response
                and tactical decision-making.
              </p>
            </div>
            <img  loading="lazy"
              src="https://images.unsplash.com/photo-1508614589041-895b88991e3e?auto=format&fit=crop&q=60"
